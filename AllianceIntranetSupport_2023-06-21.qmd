...
# 
# AllianceInpatientCensus <- data.frame(Content = CensusInpatient_RPT)
# 
# AllianceInpatientCensus <- cSplit(AllianceInpatientCensus, "Content", sep = " ")
# 
# RowsToRemove <- c(1, 3)
# 
# AllianceInpatientCensus <- AllianceInpatientCensus[-RowsToRemove]
# 
# headers <- as.character(AllianceInpatientCensus[1, ])
# 
# AllianceInpatientCensus <- AllianceInpatientCensus[-1, ]
