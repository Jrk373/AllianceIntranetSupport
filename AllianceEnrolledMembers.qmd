...
split_data <- split(AllianceEnrolledMembers, AllianceEnrolledMembers$BHHShortName)
...
for (provider_name in names(split_data)) {
  ...
  file_name <- file.path(folder_name, paste0("AllianceEnrolledMembers_", provider_name, ".csv"))
